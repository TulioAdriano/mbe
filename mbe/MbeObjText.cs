...
namespace mbe
{
	public class MbeObjText : MbeObj
	{
		...
		public const int MIN_TEXT_HEIGHT = 3000;    //0.52.00  2013/03/23
		public const int MAX_TEXT_HEIGHT = 100000;
		public const int DEFAULT_TEXT_HEIGHT = 20000;
        public const bool DEFAULT_USE_SYSTEMFONT_ON_DOC = true;

        /// <summary>
        /// On Dodument layer, use system font or not
        /// </summary>
        public bool UseSystemFontOnDoc
        {
		...
		public MbeObjText()
		{
			...
			dir = 0;
            useSystemFontOnDoc = DEFAULT_USE_SYSTEMFONT_ON_DOC;
			//vertical = false;
			//text = "";
		}
			...
			: base(mbeObjText)
		{
			...
			Dir = mbeObjText.dir;
            useSystemFontOnDoc = mbeObjText.useSystemFontOnDoc;
			...
			switch (str1) {
                ...
                case "SYSFONT_ONDOC":
                    try {
                        ...
                        useSystemFontOnDoc = (n != 0);
                    }
                    catch (Exception) { useSystemFontOnDoc = DEFAULT_USE_SYSTEMFONT_ON_DOC; }
                    return ReadCE3.RdStatus.NoError;
		...
		public override bool WrMb3Member(WriteCE3 writeCE3, Point origin)
		{
            ...
            writeCE3.WriteRecordInt("SYSFONT_ONDOC", (useSystemFontOnDoc != false ? 1 : 0));
		...
		public override void Draw(DrawParam dp)
		{
			...
			if (dp.layer != MbeLayer.LayerValue.DOC || !useSystemFontOnDoc) {
		...
		{
			if (layer == MbeLayer.LayerValue.DOC && useSystemFontOnDoc) return;
			LinkedList<CamOutBaseData> camdataLList = new LinkedList<CamOutBaseData>();
			bool reverse;
			switch (layer) {
				case MbeLayer.LayerValue.PLS:
		...
		protected int dir;
        protected bool useSystemFontOnDoc;

...
namespace mbe
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            int gerbOutUnit = Properties.Settings.Default.GerberOutUnitMETRIC;
            Properties.Settings.Default.GerberOutUnitMETRIC = gerbOutUnit;
		...
		private void OnMenuFileGerber(object sender, EventArgs e)
		{
			if (DoFileSave()) {
                ...
                CamOut.m_CamOutUnit = (Properties.Settings.Default.GerberOutUnitMETRIC > 0 ? CamOut.CamOUtUnit.METRIC : CamOut.CamOUtUnit.INCH);

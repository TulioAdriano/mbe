...
namespace mbe
{
	...
	class SetLayerWindow : Panel
	{
        ...
        private  int MEMBER_HEIGHT = 16;
        private  int TEXT_HEIGHT = 10;
        private  int TEXT_WIDTH = 35;
        private  int COLOR_SAMPLE_WIDTH = 16;
        private  int ICON_COLUMN_WIDTH = 16;
        private int ICON_DRAWSIZE = 16;
		...
		public SetLayerWindow()
		{
            ...
            MEMBER_HEIGHT = MEMBER_HEIGHT*dpi/96;
            TEXT_HEIGHT = TEXT_HEIGHT*dpi/96;
            TEXT_WIDTH = TEXT_WIDTH*dpi/96;
            COLOR_SAMPLE_WIDTH = COLOR_SAMPLE_WIDTH*dpi/96;
            ICON_COLUMN_WIDTH = ICON_COLUMN_WIDTH*dpi/96;
            ICON_DRAWSIZE = ICON_DRAWSIZE * dpi / 96;
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			for (int i = 0; i < layerCount; i++) {
                ...
                Rectangle iconDrawRect = new Rectangle(0, y, ICON_DRAWSIZE, ICON_DRAWSIZE);
				...
				if((visibleLayer & (ulong)MbeLayer.valueTable[i])!=0){
                    ...
                    iconDrawRect.X = visibleColumnX;


                    //g.DrawIcon(visibleIcon, visibleColumnX, y);
                    g.DrawIcon(visibleIcon, iconDrawRect);
				}
				...
				if((selectLayer == MbeLayer.valueTable[i])&&
				   (((ulong)selectLayer & selectableLayer) != 0)){
                    ...
                    iconDrawRect.X = selectColumnX;
					//g.DrawIcon(placeIcon, selectColumnX, y);
                    g.DrawIcon(placeIcon, iconDrawRect);

...
namespace mbe
{
	...
	class MbeObjPolygon : MbeObj
	{
		...
		public const int MIN_TRACE_WIDTH = 1270;		//0.127mm
		public const int MIN_PATTERN_GAP = 1270;		//0.127mm
		public const int MIN_THERMAL_GAP = 1270;		//0.127mm
		...
		{
			get { return (patternGap < thermalGap ? patternGap : thermalGap); }
